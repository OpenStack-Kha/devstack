...
screen_it n-cpu "cd $NOVA_DIR && sudo sg libvirtd $NOVA_DIR/bin/nova-compute"
...
if is_service_enabled horizon; then
    screen_it horizon "cd $HORIZON_DIR/openstack-dashboard/ && ./manage.py runserver 0.0.0.0:8080"
fi
